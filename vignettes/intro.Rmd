...
7. An empty slot, named "text." This is where the text data will be stored.
...
To import the texts, you'll need to import the texts to the `@text` slot. If it seems confusing that `tei2r` requires this as a separate
step, it's only because importing the texts can be a time-consuming process, especially for slower machines.:
