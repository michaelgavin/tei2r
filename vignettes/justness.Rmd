...
vignette: >
  %\VignetteIndexEntry{"Investigating Justness in the English Civil war and its Contexts Using `tei2r`"}
...
```r
  ...
  Would you like to determine the vocabulary for the corpus? [yes/no] > yes  # I'm interested in being able to do calculations across the whole corpus.
